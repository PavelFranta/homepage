...
function init(settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: "/./_app/start-fab5840d.js",
      css: ["/./_app/assets/start-0826e215.css"],
      js: ["/./_app/start-fab5840d.js", "/./_app/chunks/vendor-d0bdb272.js"]
    },
    fetched: void 0,
    floc: false,
...
var metadata_lookup = { "src/routes/__layout.svelte": { "entry": "/./_app/pages/__layout.svelte-0c8156cb.js", "css": ["/./_app/assets/pages/__layout.svelte-345f2878.css"], "js": ["/./_app/pages/__layout.svelte-0c8156cb.js", "/./_app/chunks/vendor-d0bdb272.js"], "styles": null }, ".svelte-kit/build/components/error.svelte": { "entry": "/./_app/error.svelte-63656676.js", "css": [], "js": ["/./_app/error.svelte-63656676.js", "/./_app/chunks/vendor-d0bdb272.js"], "styles": null }, "src/routes/index.svelte": { "entry": "/./_app/pages/index.svelte-ecf9bb8d.js", "css": [], "js": ["/./_app/pages/index.svelte-ecf9bb8d.js", "/./_app/chunks/vendor-d0bdb272.js"], "styles": null } };
...
var css = {
  code: ".scale15.svelte-1b68jz7{transform:scale(1.5)}.scale1.svelte-1b68jz7,.scale15.svelte-1b68jz7{transition:all .6s}.scale1.svelte-1b68jz7{transform:scale(1)}",
  map: `{"version":3,"file":"nav-item.svelte","sources":["nav-item.svelte"],"sourcesContent":["<script lang=\\"typescript\\">import { fly } from 'svelte/transition';\\nexport let component;\\nexport let index;\\nlet shouldScale = false;\\nsetTimeout(() => {\\n    setTimeout(() => {\\n        shouldScale = true;\\n    }, index * 400);\\n    setTimeout(() => {\\n        shouldScale = false;\\n    }, index * 600);\\n}, 400);\\n<\/script>\\n\\n<div \\n  in:fly={{ y: 200, duration: 500 }}\\n  class:scale15={shouldScale}\\n  class:scale1={!shouldScale}\\n  class=\\"px-2\\">\\n\\t<svelte:component this={component} />\\n</div>\\n\\n<style>.scale15{transform:scale(1.5)}.scale1,.scale15{transition:all .6s}.scale1{transform:scale(1)}</style>\\n"],"names":[],"mappings":"AAsBO,uBAAQ,CAAC,UAAU,MAAM,GAAG,CAAC,CAAC,sBAAO,CAAC,uBAAQ,CAAC,WAAW,GAAG,CAAC,GAAG,CAAC,sBAAO,CAAC,UAAU,MAAM,CAAC,CAAC,CAAC"}`
};
var Nav_item = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${[
    "px-2 svelte-1b68jz7",
    (shouldScale ? "scale15" : "") + " " + (!shouldScale ? "scale1" : "")
  ].join(" ").trim()}">${validate_component(component || missing_component, "svelte:component").$$render($$result, {}, {}, {})}
</div>`;
});
var Nav = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<nav class="${"flex p-3 justify-end"}">${delayedVisibility ? `${each(menuItems, ({ component }, index2) => `${validate_component(Nav_item, "NavItem").$$render($$result, { component, index: index2 + 1 }, {}, {})}`)}` : ``}</nav>`;
});
var _layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `${validate_component(Nav, "Nav").$$render($$result, {}, {}, {})}
<div class="${"p-1 sm:px-6"}">${slots.default ? slots.default({}) : ``}</div>`;
});
